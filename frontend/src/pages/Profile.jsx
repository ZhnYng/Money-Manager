...
export default function Profile(){
  const [user, setUser] = React.useState(jwtDecode(localStorage.getItem('token')))
  console.log(user)
  return (
    <div className='h-screen absolute top-0 w-screen -z-50 bg-green-300'>
      <div className='relative h-1/4'>
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-box-arrow-left text-white absolute right-0 m-2" viewBox="0 0 16 16">
